...
/* moved macro from lib.c to lib.h, so they can be used by other files */
#define VIDEO       0xB8000
#define NUM_COLS    80
#define NUM_ROWS    25
#define ATTRIB      0x7
#define CURSOR_CMD  0x03D4
#define CURSOR_DATA 0x03D5
/* terminal text color section: bit 7-4(background), bit 3-0(text color)
 * $00 Black        $01 Blue            $02 Green       $03 Cyan    
 * $04 Red          $05 Magenta         $06 Brown       $07 White
 * $08 Gray         $09 Light Blue      $0A Light Green $0B Light Cyan
 * $0C Light Red    $0D Light Magenta   $0E Yellow      $0F Bright White
 */
#define ATTRIB_T1   0xD
#define ATTRIB_T2   0xA
#define ATTRIB_T3   0xE
